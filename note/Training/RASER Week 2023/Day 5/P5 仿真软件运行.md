...
# 遇到问题
- 登陆服务器时出现报错
      ![](https://raser-1314796952.cos.ap-beijing.myqcloud.com/media/wkq20230128%20failed%20to%20log%20in%20to%20the%20server.png)
    - 解决方法：
        删除或移走 .vscode 文件（mv命令）
        新建 .vscode空文件（touch命令）

- 上述步骤第二部分克隆：git clone 克隆地址时，出现报错
    - 解决办法：git clone https://username:password@remote-git-repository-url